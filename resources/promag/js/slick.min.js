	...
	b = function () {
		function c(c, d) {
			...
			e.defaults = {
				...
				arrows: !0,
				asNavFor: null,
				prevArrow: '<button type="button" data-role="none" class="flaticon-back45 proMag-prev" aria-label="Previous" tabindex="0" role="button"></button>',
				nextArrow: '<button type="button" data-role="none" class="flaticon-right150 proMag-next" aria-label="Next" tabindex="0" role="button"></button>',
				autoplay: !1,
				autoplaySpeed: 3e3,
				centerMode: !1,
				centerPadding: "50px",
